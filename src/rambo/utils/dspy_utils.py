...
from rambo.tools.retrieval import get_embedding_function, get_dummy_retriever
...
def init_dspy(
    ...
    if retrieval_type == "embedding":
        ...
        raise ValueError(f"Unknown retrieval type: {retrieval_type}, choose from 'embedding', 'test', 'agent'")
